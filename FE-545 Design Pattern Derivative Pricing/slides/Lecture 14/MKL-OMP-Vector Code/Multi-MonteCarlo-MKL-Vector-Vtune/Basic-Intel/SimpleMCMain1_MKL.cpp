...
//	//vslNewStream(&stream, VSL_BRNG_MT2203, seed); /* Alternative RNG */
//	vdRngGaussian(VSL_RNG_METHOD_GAUSSIAN_ICDF, stream, MAX_PATHS, RN_ARRAY, 0, 1);
//	//vdRngGaussian(VSL_RNG_METHOD_GAUSSIAN_BOXMULLER2, stream, MAX_PATHS, RN_ARRAY, 0, 1); /* Alternative distribution generator */
//
