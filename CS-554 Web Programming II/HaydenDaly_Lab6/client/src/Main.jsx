...
function Main() {
  ...
  const { loading, data } = useQuery(queries.GET_UNSPLASH_IMAGES, {
  ...
  useEffect(() => {
    if (data) {
      let newData = posts.concat(data.unsplashImages);
  ...
  return (
    <div>
      ...
      >
        <a href="/my-bin">my bin</a> | <a style={{ color: "blue" }} href="/">images</a> |{" "}
